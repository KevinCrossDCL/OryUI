...
function HomeScreen()
	...
	buttonOryUIURL as integer : buttonOryUIURL = OryUICreateButton("size:90,5;text:OryUI on GitHub;offset:45,0;position:50," + str(contentHeight#) + ";alpha:0;textColor:#0000EE;depth:20")
	contentHeight# = contentHeight# + OryUIGetButtonHeight(buttonOryUIURL) + 1
	
	buttonAGKURL as integer : buttonAGKURL = OryUICreateButton("size:90,5;text:AppGameKit.com;offset:45,0;position:50," + str(contentHeight#) + ";alpha:0;textColor:#0000EE;depth:20")
