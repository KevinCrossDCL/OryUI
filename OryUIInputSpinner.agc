...
foldstart // OryUIInputSpinner Widget (Updated 07/07/2020)
...
function OryUICreateInputSpinner(oryUIWidgetParameters$ as string)
	...
	SetSpritePhysicsOff(OryUIInputSpinnerCollection[oryUIInputSpinnerID].sprContainer)
	...
	SetSpritePhysicsOff(OryUIInputSpinnerCollection[oryUIInputSpinnerID].sprInvisibleCover)
	...
	SetSpritePhysicsOff(OryUIInputSpinnerCollection[oryUIInputSpinnerID].buttons[1].sprIcon)
	...
	SetSpritePhysicsOff(OryUIInputSpinnerCollection[oryUIInputSpinnerID].buttons[2].sprContainer)
