...
function OryUIUpdateTemplate(oryUITemplateID as integer, oryUIWidgetParameters$ as string)
	...
	if (GetSpriteExists(OryUITemplateCollection[oryUITemplateID].sprContainer))
		...
		elseif (oryUIParameters.offsetTopCenter = 1)
			SetSpriteOffset(OryUITemplateCollection[oryUITemplateID].sprContainer, GetSpriteWidth(OryUITemplateCollection[oryUITemplateID].sprContainer) / 2.0, 0)
		elseif (oryUIParameters.offsetTopRight = 1)
			SetSpriteOffset(OryUITemplateCollection[oryUITemplateID].sprContainer, GetSpriteWidth(OryUITemplateCollection[oryUITemplateID].sprContainer), 0)
		elseif (oryUIParameters.offsetCenterLeft = 1)
			SetSpriteOffset(OryUITemplateCollection[oryUITemplateID].sprContainer, 0, GetSpriteHeight(OryUITemplateCollection[oryUITemplateID].sprContainer) / 2.0)
		elseif (oryUIParameters.offsetCenter = 1)
			SetSpriteOffset(OryUITemplateCollection[oryUITemplateID].sprContainer, GetSpriteWidth(OryUITemplateCollection[oryUITemplateID].sprContainer) / 2.0, GetSpriteHeight(OryUITemplateCollection[oryUITemplateID].sprContainer) / 2.0)
		elseif (oryUIParameters.offsetCenterRight = 1)
			SetSpriteOffset(OryUITemplateCollection[oryUITemplateID].sprContainer, GetSpriteWidth(OryUITemplateCollection[oryUITemplateID].sprContainer), GetSpriteHeight(OryUITemplateCollection[oryUITemplateID].sprContainer) / 2.0)
		elseif (oryUIParameters.offsetBottomLeft = 1)
			SetSpriteOffset(OryUITemplateCollection[oryUITemplateID].sprContainer, 0, GetSpriteHeight(OryUITemplateCollection[oryUITemplateID].sprContainer))
		elseif (oryUIParameters.offsetBottomCenter = 1)
			SetSpriteOffset(OryUITemplateCollection[oryUITemplateID].sprContainer, GetSpriteWidth(OryUITemplateCollection[oryUITemplateID].sprContainer) / 2.0, GetSpriteHeight(OryUITemplateCollection[oryUITemplateID].sprContainer))
		elseif (oryUIParameters.offsetBottomRight = 1)
			SetSpriteOffset(OryUITemplateCollection[oryUITemplateID].sprContainer, GetSpriteWidth(OryUITemplateCollection[oryUITemplateID].sprContainer), GetSpriteHeight(OryUITemplateCollection[oryUITemplateID].sprContainer))
		else
