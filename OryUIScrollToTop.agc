...
function OryUICreateScrollToTop(oryUIComponentParameters$ as string)
	...
	SetSpritePhysicsOff(OryUIScrollToTopCollection[oryUIScrollToTopID].sprShadow)
	...
	SetSpritePhysicsOff(OryUIScrollToTopCollection[oryUIScrollToTopID].sprContainer)
	...
	SetSpritePhysicsOff(OryUIScrollToTopCollection[oryUIScrollToTopID].sprIcon)
